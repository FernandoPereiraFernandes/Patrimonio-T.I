...
interface AssetFormDialogProps {
  ...
  ativo?: Ativo | null; // quando passado, modo edição
}
...
export function AssetFormDialog({
  ...
  useEffect(() => {
    if (open) {
      if (ativo) {
        ...
        try {
          parsedSpecs = ativo.especificacoes
            ? JSON.parse(ativo.especificacoes)
            : {};
        } catch {
          parsedSpecs = {};
        }
  ...
  // Quando muda a categoria, inicializa os campos de especificação
